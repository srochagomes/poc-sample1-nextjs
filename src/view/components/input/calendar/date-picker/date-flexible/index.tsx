...
import { GroupButtonItemData, GroupButtonItemProps } from '@/view/components/button/group-selecting/button';
import { useTranslation } from "next-i18next"
import InputField from '@/view/components/input/text';
import { FieldTypeEnum } from '@/types/enums/FieldTypeEnum';
import CheckboxList from '@/view/components/input/checkbox/common';
import { useState } from 'react';
import RadioButtonList from '@/view/components/input/radiobutton/common';
